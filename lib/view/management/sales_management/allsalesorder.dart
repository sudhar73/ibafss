...
class AllSalesorder extends StatefulWidget {
  ...
  @override
  _AllSalesorderState createState() => _AllSalesorderState();
}
...
// ignore: avoid_unnecessary_containers
            Center(
              child: Container(
                  child: Text("All Sales Orders", style: Texts.primary1d())),
            ),
            SizedBox(height: 5),
            Container(
              width: Get.width / 1,
...
// ),
  ...
  _addexit(BuildContext context) {
    ...
    return new AlertDialog(
      ...
      title: Center(
          child: Text('All Sales Orders', style: Texts.primary1bigbold())),
  ...
  List<Employee> getEmployeeData() {
    return [
       Employee('Karthik','LD001','Ocean','Prakash','Prakash@gmail.com',9876543210,12-12-2020,18-12-2020,'Chennai','Chennai','SER001','Cleaning',25,2,50,20,90,10,5,100,'Approved','Edit Delete'),
    ];
  }
}
