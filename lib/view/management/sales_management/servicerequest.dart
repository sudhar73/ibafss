...
// ),
  ...
  _addexit(BuildContext context) {
    ...
    return new AlertDialog(
      ...
      title: Center(
          child: Text('Service Request', style: Texts.primary1bigbold())),
  ...
  List<Employee> getEmployeeData() {
    return [
      Employee(
          1, 'UTRTY9075', 'Shahi', 'Pending', 12 - 12 - 2020, 'Edit Delete'),
      Employee(
          2, 'GYIO658', 'Kalai', 'Approved', 14 - 02 - 2020, 'Edit Delete'),
      Employee(
          3, 'TJHG9866', 'Siva', 'Declined', 15 - 07 - 2020, 'Edit Delete'),
      Employee(
          1, 'UTRTY9075', 'Shahi', 'Pending', 12 - 12 - 2020, 'Edit Delete'),
      Employee(
          2, 'GYIO658', 'Kalai', 'Approved', 14 - 02 - 2020, 'Edit Delete'),
...
class Employee {
  ...
  Employee(
      this.id, this.name, this.designation, this.salary, this.date, this.act);
